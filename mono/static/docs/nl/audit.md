...
3. **Kies de sjabloon** (bijvoorbeeld FIN / OLD_BOSA / OLD_FIN) zodat de Excel op
   dezelfde manier wordt gelezen als de Import-route dat doet. Optioneel **titels
   negeren** als alleen prompts en antwoorden van belang zijn.
